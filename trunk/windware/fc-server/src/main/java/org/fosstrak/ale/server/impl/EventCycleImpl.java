...
public final class EventCycleImpl implements EventCycle, Runnable {
	...
	private static final Logger PERFORMANCE = Logger.getLogger("org.fosstrak.ale.server.impl.EventCycleImpl.performance");
	...
	private List<ECReport> getReportList() throws ECSpecValidationException, ImplementationException {
		...
		PERFORMANCE.debug("Time: " + estimated+"\t Reprts:"+reports.size());
		return ecReports;		
	}
