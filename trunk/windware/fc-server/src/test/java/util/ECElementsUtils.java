...
public class ECElementsUtils extends Assert {
	...
	private static final boolean INCLUDE_ID = true;
	private static final boolean INCLUDE_SENSOR = true;
	...
	public static ECReportOutputSpec createECReportOutputSpec() {
		...
		spec.setIncludeID(INCLUDE_ID);
		spec.setIncludeSensor(INCLUDE_SENSOR);
